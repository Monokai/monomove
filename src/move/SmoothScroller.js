...
export default class {
	...
	constructor({
		...
		this.isFirstScrollInstant = true;
		this.isTouch = false;
		...
		this.touchStartListener = () => {
			...
			this.isTouch = true;
			// todo: doesn't reset to initial state when using mouse after touch
		};
	...
	triggerAnimations(all = false) {
		...
		animations.forEach(a => {
			...
			const pos = box.top + box.height - o.scroll + directionOffset * (this.isDown ? -1 : 1) * this.height + offset * this.height;
			...
			if (this.debugContext && (o.box.top + o.box.height - o.scroll >= 0 && o.box.top - o.scroll <= this.height)) {
				this.debugContext.rect(o.box.left * r, o.box.top * r - o.scroll * r, o.box.width * r, o.box.height * r);
			}
		});
